    ...
    <section className=" min-h-screen">
      <div className="h-full">
        <div className="flex h-full justify-center p-4 lg:gap-32 lg:p-0">
          ...
          {/*  */}
          <div className=" relative hidden min-h-screen  bg-customBlack  max-lg:hidden lg:block lg:w-1/3  ">
            ...
            <div className="absolute inset-x-0 h-full overflow-hidden">
              <span className="absolute right-[34%] top-[3%] block aspect-square w-10 rounded-full border border-gray-100/60 "></span>
              <span className="absolute right-[42%] top-[12%] block aspect-square w-6 rounded-full border border-gray-100/60 "></span>
              ...
              <span className="absolute right-[55%] top-[10%] block aspect-square w-14 rounded-full border border-gray-100/60 "></span>
              ...
              <span className="absolute right-[50%] top-[65%] block aspect-square w-20 rounded-full border border-gray-100/60 "></span>
              <span className="absolute right-[68%] top-[80%] block aspect-square w-4 rounded-full border border-gray-100/60 "></span>
              ...
              <span className="absolute right-[39%] top-[87%] block aspect-square w-16 rounded-full border border-gray-100/60 "></span>
            </div>
          </div>
        </div>
      </div>
